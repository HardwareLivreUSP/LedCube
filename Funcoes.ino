...
void box_wireframe(int x1, int y1, int z1, int x2, int y2, int z2)
{
	...
	// Lines along X axis
	data[z1][y1] = byteline(x1,x2);
	data[z1][y2] = byteline(x1,x2);
	data[z2][y1] = byteline(x1,x2);
	data[z2][y2] = byteline(x1,x2);
